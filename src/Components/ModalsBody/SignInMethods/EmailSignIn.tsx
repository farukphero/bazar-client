  ...
  const handleSignUpOpen = () => {
    ...
    return (
        ...
        <div className="flex justify-between">
          <Link onClick={handleSignInOpen} href={"/signIn"} className="btn btn-primary btn-sm text-white mb-5">
            Sign In
          </Link>
          <Link onClick={handleSignUpOpen} href={"/signUp"} className='text-xl underline'>
            Sign Up
          </Link>
        </div>
